describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    cy.visit('/add/0x3123111edf985abe2f9c711cdc9cbfd4d3868c53-0xe9e7cea3dedca5984780bafc599bd69add087d56')
  ...
  it('does not crash if CAKE is duplicated', () => {
    cy.visit('/add/0x3123111edf985abe2f9c711cdc9cbfd4d3868c53-0x3123111edf985abe2f9c711cdc9cbfd4d3868c53')
    cy.get('#add-liquidity-input-tokena .token-symbol-container').should('contain.text', 'CAKE')
